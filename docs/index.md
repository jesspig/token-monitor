...
> **2026-08-28 知识库与代码一致性对齐**：全部代码注释已移除，`docs/` 为唯一事实来源；本轮修订概念页过时表述（5→8 插件）、SSOT 锚点改指向代码符号、机制编号与术语统一，并同步 `AGENTS.md`。详见 [changelog/2026-08-28-02](changelog/2026-08-28-02.md)。
...
- [数据模型](concepts/data-model.md) — SQLite 六张核心表结构设计（含失败可观测 v8/v9 与 http_status/error_message）。
