...
> [!note] 截至 2026-09-10
> 已交付 8 个内置监控插件、统计查询卸载到只读 worker 线程、系统托盘后台常驻、仪表盘双图合并与趋势页退役、查询预聚合与联合索引 v11；图表层已由 Recharts 迁移至 ECharts 6.1；全部代码注释已于 2026-08-28 移除，`docs/` 为唯一事实来源。
